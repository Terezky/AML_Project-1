...
Below is the repository structure to help navigate through the various segments and files
...
The goal of this project is to have a statistically relevant predicition for the outcome of a parameter "Quality".
Given are a set of parameters that 
